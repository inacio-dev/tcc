...
O `send_connect_to_client()` re-resolve o hostname para atualizar o IP caso o DHCP mude. Essa re-resolução ocorre sempre que o comando CONNECT é enviado ao cliente, em vez de 160 vezes por segundo (100Hz sensores + 60Hz vídeo).
