...
class F1Logger:
    ...
    def _should_log(self, level: LogLevel, message: str = "", rate_limit: float = 0) -> bool:
        """
    ...
    def _format_message(self, level: LogLevel, message: str, component: str = "") -> str:
    ...
    def _log(self, level: LogLevel, message: str, component: str = "", rate_limit: float = 0):
