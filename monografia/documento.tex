...
\departamento{Departamento de Engenharia da Computação}
...
\titulo{Implementação de Sistema de Teleoperação com Feedback Háptico Baseado em Raspberry Pi e Arduino}
\data{2026}
\local{Fortaleza}
...
\begin{document}
  ...
  \imprimirglossario
	\imprimirapendices
		...
		\input{3-pos-textuais/apendices/Diagrama - RPi}
		\input{3-pos-textuais/apendices/exemplo-transmissao}
		\input{3-pos-textuais/apendices/specs-equipamentos}
		\input{3-pos-textuais/apendices/algoritmos-auxiliares}
	%\imprimiranexos
