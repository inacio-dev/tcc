...
O simulador utiliza o volante Logitech G923, um dispositivo profissional de simulação que integra volante com rotação de 900°, pedais progressivos de acelerador e freio, paddle shifters para troca de marchas e motor de force feedback com sistema TRUEFORCE, em um único periférico USB, conforme ilustrado na \autoref{fig:g923-volante}. A escolha do G923 como dispositivo de entrada do simulador foi motivada pela superior precisão dos sensores internos, \textit{force feedback} nativo sem necessidade de ponte H externa, e eliminação de \textit{firmware} customizado e calibração manual. O G923 é reconhecido pelo sistema operacional Linux como dispositivo de entrada padrão, acessível através da interface evdev do kernel.
...
\IBGEtab{}{%
	\begin{tabular}{p{2.5cm}p{2.5cm}p{3cm}p{6.5cm}}
		...
		\midrule
		FF\_PERIODIC & Vibração & Acelerador & Vibração senoidal simulando RPM do motor (5 a 12Hz) \\
		\bottomrule
	\end{tabular}%
}{%
\Fonte{elaborado pelo autor.}%
