/**
 * @file test_throttle_encoder.ino
 * @brief Teste independente do encoder de aceleracao (LPD3806-600BM-G5-24C)
 *
 * Pinagem:
 * - CLK (A): GPIO 25 - Fio Branco
 * - DT (B):  GPIO 26 - Fio Verde
 * - VCC:     5V      - Fio Vermelho
 * - GND:     GND     - Fio Preto
 *
...
void setup() {
    ...
    Serial.println("=====================================");
    Serial.println("  TESTE: ENCODER ACELERACAO (THROTTLE)");
    Serial.println("=====================================");
    Serial.println();
    Serial.println("Pinagem:");
    Serial.println("  CLK (A): GPIO 25 - Fio Branco");
    Serial.println("  DT (B):  GPIO 26 - Fio Verde");
