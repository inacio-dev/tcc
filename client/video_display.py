...
class VideoDisplay:
    ...
    def create_window(self):
        """Cria e configura a janela de vídeo"""
        try:
            ...
            self._log(
                "INFO",
                f"Janela de vídeo criada: {self.window_width}x{self.window_height}",
            )
    ...
    def run_display(self):
        ...
        self._log("INFO", "Iniciando display de vídeo...")

        if not self.create_window():
            self._log("ERROR", "Falha ao criar janela de vídeo")
            return
        ...
        try:
            while self.is_running:
                ...
                # Verifica eventos da janela
                if not self.check_window_events():
                    break
